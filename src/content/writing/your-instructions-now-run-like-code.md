---
title: "Your Instructions Now Run Like Code"
description: "Why your plain-English documentation is more valuable than ever."
...
- **["Using CLAUDE.md Files"](https://claude.com/blog/using-claude-md-files) — Anthropic** — The official guide to writing AI-readable instruction files that make your operations manual executable.
- **["Introducing Agent Skills"](https://claude.com/blog/skills) — Anthropic** — Skills let you package your instructions into reusable, portable capabilities that guide Claude's work.
