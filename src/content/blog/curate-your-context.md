---
title: "Curate Your Context"
description: "Your AI is only as good as the context you give it. Learn how curation—not collection—creates the leverage."
...
Over the last two weeks, I've written about [getting your thinking into text](/blog/ai-runs-on-text) and [using voice to make that capture effortless](/blog/voice-is-the-missing-link). Now comes the next step: learning to curate that material so it actually works for you, not against you.
...
- **["Effective Context Engineering for AI Agents"](https://www.anthropic.com/engineering/effective-context-engineering-for-ai-agents)** — Anthropic — The technical foundation for understanding how context actually works in LLM systems and why "smallest possible set of high-signal tokens" matters.
- **["The Collector's Fallacy"](https://zettelkasten.de/posts/collectors-fallacy/)** — Zettelkasten — Why saving without processing creates the illusion of knowledge. The same trap exists with AI context.
- **["What Is A Swipe File? (+ How To Create One)"](https://www.swipefiles.com/what-is-a-swipe-file)** — Corey Haines / SwipeFiles — How a marketing professional systematically curates examples for strategic reference.
