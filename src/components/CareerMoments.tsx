        ...
        <div className="border-b border-border lg:border-b-0 lg:border-r lg:self-start">
          <div className="border-b border-border p-5 sm:p-6">
            <p className="text-lg font-semibold tracking-tight">
              13+ years moving between strategy, design, and code
            </p>
          </div>
        ...
        <div className="group block min-h-[420px] lg:relative lg:min-h-0">
          <div className="grid h-full min-h-[420px] grid-rows-[minmax(0,1fr)_auto] bg-card lg:absolute lg:inset-0 lg:min-h-0">
            <div className="relative overflow-hidden bg-muted">
              ...
              <div className="absolute inset-0 bg-[linear-gradient(to_right,var(--border)_1px,transparent_1px),linear-gradient(to_bottom,var(--border)_1px,transparent_1px)] bg-[size:44px_44px] opacity-[0.16]" />
            </div>

            <div className="border-t border-border bg-card p-5 sm:p-6">
              <div className="grid gap-5 lg:grid-cols-[1fr_auto] lg:items-end">
                <div className="max-w-2xl">
                  <h3 className="text-xl font-medium leading-snug tracking-tight sm:text-2xl">
