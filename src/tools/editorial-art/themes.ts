...
export const themeList: ThemeConfig[] = [
  {
    ...
    defaultFoundation: { type: 'strange-attractor', seed: 42,  opacity: 85, color: 'copper' },
    defaultTexture: 20,
  ...
  },
  {
    ...
    label: 'Design',
    defaultBgColor: brand.warmDarkGray,
    defaultFoundation: { type: 'isoline',           seed: 137, levels: 12, scale: 350, strokeWidth: 0.7, opacity: 75, color: 'copper' },
    defaultTexture: 0,
    defaultComposition: 'left',
  },
  {
    ...
    label: 'Systems',
    defaultBgColor: brand.warmDarkGray,
    defaultFoundation: { type: 'voronoi',            seed: 73,  count: 60, jitter: 60, strokeWidth: 0.6, opacity: 75, color: 'copper' },
    defaultTexture: 0,
    defaultComposition: 'left',
  },
  {
    ...
    defaultBgColor: brand.warmDarkGray,
    defaultFoundation: { type: 'flow-field',         seed: 256, density: 150, steps: 100, scale: 320, curl: 30, strokeWidth: 1.0, opacity: 75, color: 'copper' },
    defaultTexture: 20,
  ...
  },
  {
    ...
    label: 'Career',
    defaultBgColor: brand.warmDarkGray,
    defaultFoundation: { type: 'dot-grid',           seed: 512, spacing: 22, scale: 300, dotSize: 70, opacity: 70, color: 'copper' },
    defaultTexture: 0,
    defaultComposition: 'left',
  },
];
